...
/// </summary>
    ...
    {
        private Dictionary<string, Person> people = new Dictionary<string, Person>(); //create addressBook Dictionary

        //method of interface
        public void AddContact(string firstName, string lastName, string address, string city, string state, int email, int zip, long phoneNumber)
        {
        ...
        public void ViewContact()
        {
            ...
            foreach (KeyValuePair<string, Person> item in people) //print all values using foreach  in addressBook Dictionary
            {
        ...
        {
            foreach (KeyValuePair<string, Person> item in people) //use loop foreach
            {
                if (item.Key.Equals(name))
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case 6:
                            ...
                            item.Value.Email = Convert.ToInt32(Console.ReadLine());
                            break;
                        case 7:
